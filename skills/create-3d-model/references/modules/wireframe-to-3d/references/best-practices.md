...
**Purpose**: Expert knowledge and established patterns for building robust, performant Blender scripts integrated with dsh agent.
...
def setup_viewport_for_screenshot(max_size=800):
    ...
    # Return screenshot via `blender_python`
```
