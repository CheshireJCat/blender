...
**Target Audience**: Skill developers integrating wireframe analysis into dsh Blender toolchain workflow.
...
**Next**: Create SKILL.md with decision logic and dsh agent MCP orchestration
